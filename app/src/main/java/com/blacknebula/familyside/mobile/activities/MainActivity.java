...
import com.blacknebula.familyside.mobile.fragments.ContentFragment;
import com.blacknebula.familyside.mobile.fragments.MapsFragment;
...
public class MainActivity extends AppCompatActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    private void createMenuList() {
        ...
        list.add(menuItem0);
        SlideMenuItem menuItem = new SlideMenuItem(MapsFragment.MAPS, R.mipmap.map);
        list.add(menuItem);
        SlideMenuItem menuItem2 = new SlideMenuItem(ContentFragment.HISTORY, R.mipmap.history);
        list.add(menuItem2);
        SlideMenuItem menuItem3 = new SlideMenuItem(ContentFragment.GROUPS, R.mipmap.group_add);
        list.add(menuItem3);
    }
    ...
    public ScreenShotable onSwitch(Resourceble slideMenuItem, ScreenShotable screenShotable, int position) {
        switch (slideMenuItem.getName()) {
            ...
            case MapsFragment.MAPS:
                return showMaps(screenShotable, position);
            default:
    ...
    private ScreenShotable showMaps(ScreenShotable screenShotable, int topPosition) {
        View view = findViewById(R.id.content_frame);
        int finalRadius = Math.max(view.getWidth(), view.getHeight());
        SupportAnimator animator = ViewAnimationUtils.createCircularReveal(view, 0, topPosition, 0, finalRadius);
        animator.setInterpolator(new AccelerateInterpolator());
